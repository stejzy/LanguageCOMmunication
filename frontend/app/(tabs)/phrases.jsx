        ...
        <SafeAreaView style={styles.contentContainer}>
            ...
            <View style={styles.viewOuterStyle}>
                <View style={[styles.viewInnerStyle, { flex: hasText ? 0.5 : 1 }]}>
                    ...
                    {hasText && (
                        <Pressable onPress={handleGenerate} style={styles.iconGenerateButton}>
                                    ...
                                    <View style={styles.actionColumn}>
                                        ...
                                        >
                                            {supportedLanguages.map((lang, i) => (
                                                <Picker.Item key={i} label={lang.languageName.charAt(0) + lang.languageName.slice(1).toLowerCase()} value={lang.languageCode} />
                                            ))}
                                        </Picker>

                                        <View style={styles.buttonRow}>
                                            <Pressable onPress={() => handleTranslate(phraseText, index)} style={styles.iconButton}>
                                                <Feather name="globe" size={20} color="black" />
                                            </Pressable>
                                            <Pressable onPress={() => Clipboard.setString(phraseText)} style={styles.iconButton}>
